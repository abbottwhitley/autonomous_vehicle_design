...
<p align="center">
    ...
    <b>The output value at time t = n&Delta;t is the input at time t = (n-1)&Delta;t</b><br>
</p>


3. Two term difference filter:
<p align="center">
    <b>y<sub>n</sub> = x<sub>n</sub> - x<sub>n-1</sub></b><br>
    <b>The output value at time t = n&Delta;t is equal to the difference between the current input and the previous input. This is similar to an analog differentiator circuit.</b><br>
</p>


4. Two term average filter:
<p align="center">
    <b>y<sub>n</sub> = (x<sub>n</sub> + x<sub>n-1</sub>)/2</b><br>
    <b>The output of the current input and the previous input. This is a simple type of low pass filter as it tends to smooth out high-frequency variations in a signal.</b><br>
</p>
...
<p align="center">
    <b>Recursive: y<sub>5</sub> = x<sub>5</sub> + y<sub>4</sub></b><br>
    <b>Non-recurseive: y<sub>5</sub> = x<sub>5</sub> + x<sub>4</sub> +  x<sub>3</sub> + x<sub>2</sub> + x<sub>1</sub> + x<sub>0</sub> </b><br>
</p>
